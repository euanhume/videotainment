 ...
 * @property string $ProductTypeImgPrefix
 */
class ProductType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('ProductTypeImgPrefix', 'required'),
			array('ProductTypeName', 'length', 'max'=>255),
			array('ProductTypeImgPrefix', 'length', 'max'=>11),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ProductTypeID, ProductTypeName, ProductTypeImgPrefix', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'ProductTypeImgPrefix' => 'Product Type Img Prefix',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('ProductTypeImgPrefix',$this->ProductTypeImgPrefix,true);
